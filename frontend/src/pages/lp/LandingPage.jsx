      ...
      <footer className="border-t border-line">
        <div className="max-w-[1180px] mx-auto px-6 py-8 flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex items-center gap-5 text-text-faint text-[12px]">
            ...
            {/* Links legais (Privacidade/Termos/Cookies/Canal LGPD) prontos em
                /privacidade etc., mas AINDA NÃO linkados publicamente — só
                publicar após revisão jurídica e preenchimento dos dados. */}
